...
This should allow you to directly import `src/mlops_training` in your notebook.
...
Run `python -m ipykernel install --user --name="mlops_training"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called mlops_training should be available in the
